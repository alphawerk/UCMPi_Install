...
You can skip down to 'Installing Node-Red and alphaWerk components' if you used the prepared OS image provided by alphawerk when flashing the device (https://uhai.alphawerk.co.uk/scripts/cm_alphawerk.img.zip)
